...
const IFRDownloadPDF = ({ navigation }) => {
    ...
    const carouselItems = [
        {
            ...
            imageName: require('../../assets/images/FormPreviews/Page1_IFRForm.jpg'),
        },
    ...
    const handleDownload = async (vNameEnglish) => {
        ...
        try {
            ...
            const response = await Linking.openURL(`${BASE_URL}/get-ifr-form`);
