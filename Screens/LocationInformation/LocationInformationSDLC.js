...
const LocationInformationSDLC = ({navigation}) => {
    ...
    request('/claims-by-frc', {
      ...
      .then(({data}) => {
        if (data?.success === false) {
          ...
          setResult({
            active: data?.claimCount,
            alerts: data?.alertsCount,
            submitted: data?.submittedClaims,
          });
          console.log(data);
        }
      })
          ...
          <KeyboardAvoidingView>
            <View style={styles.header}>
              <View style={styles.name}>
                <Text style={styles.nameTxt}>स्थानवार दावा स्थिति</Text>
              </View>
              {/* <Text>{authLevel}</Text> */}
            ...
            <View style={styles.screen}>
              <View style={styles.container}>
                <Text style={styles.text}>आवेदन संख्या : {result.active} </Text>
                <Text style={styles.text}>
                  डीएलसी को प्रस्तुत : {result?.submitted}{' '}
                </Text>
                <Text style={styles.text}>अलर्ट : {result?.alerts}</Text>
              </View>
            </View>
...
export default LocationInformationSDLC;
