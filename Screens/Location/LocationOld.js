...
const LocationScreen = ({ navigation }) => {
    ...
    const { name, panchayat, tehsil, statet, district, postLevel, authLevel } = useSelector(state => state.entities.auth.userInfo?.profile);
                        ...
                        {formik.values.state !== '' && (
                            <>
                                ...
                                <Dropdown
                                    visible={true}
                                    data={
                                        states?.filter(item => item.label === formik.values.state)?.map(item => {
