...
const FormsPage = ({navigation}) => {
  ...
  const getDistrict = (blank = true) =>
    blank ? '....................' : t(profile?.district);
  const getPanchayat = (blank = true) =>
    blank ? '....................' : t(profile?.panchayat);
  const getTehsil = (blank = true) =>
    blank ? '....................' : t(profile?.tehsil);
  const getVillage = (blank = true) =>
    blank ? '....................' : t(profile?.village);
  ...
  const handleDownload = async vNameEnglish => {
    ...
    try {
      ...
      const response = await Linking.openURL(
        `${BASE_URL}/get-documents?f0=${FD[0]}&f9=${FD[0]}&vName=${vNameEnglish}`,
      );
          ...
          <CustomButton
            ...
            onPress={async () => {
              ...
              try {
                ...
                setTimeout(async () => {
                  await handleDownload(getEnglish(vName));
                  setProgress(0);
                }, 100);
              } catch (err) {
